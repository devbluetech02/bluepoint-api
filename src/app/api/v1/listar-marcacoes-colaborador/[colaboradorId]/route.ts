...
export async function GET(request: NextRequest, { params }: Params) {
  return withAuth(request, async (req, user) => {
    try {
      ...
      // Garantia de privacidade: colaborador comum só vê os próprios dados.
      // Gestor precisa estar no escopo (gestor_departamentos / gestor_empresas
      // / departamento próprio em comum).
